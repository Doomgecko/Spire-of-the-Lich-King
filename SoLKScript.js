...
let player = {
    ...
    SPAttack(){
        if (player.playerSP >= 3) {
            ...
            player.playerSP -= 3;
            view.updatePlayer();
            document.getElementById("errorReport").innerHTML = "You prepare a mighty strike (Damage +10)";
        }else{
            document.getElementById("errorReport").innerHTML = "You don't have enough Stamina.";
        }
    },
...
let upkeep = {
    processTurn(){
        ...
        if (monster.monsterHP <= 0){
            ...
            document.getElementById("monsterName").innerHTML = "Dead";
            document.getElementById("monsterHP").innerHTML = "";
            document.getElementById("monsterTelegraph").innerHTML = "The Minotaur lies dead."
            view.updateMonster();
        }else{
